...
public final class PATH_CONST {

    public static final String PROPERTY_APP = "classpath:application.properties";
    public static final String PROPERTY_BOT= "classpath:bot.properties";
